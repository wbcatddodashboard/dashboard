...
export const GlobalCatDDO = () => {
  return (
    <GlobalWrapper>
      <GlobalContainer>
        <GlobalTitle>
          Distribution of Cat DDOs by Global Department and Operation Type
        </GlobalTitle>

        <GlobalContentWrapper>
          <GlobalBulletPointsContainer>
            <GlobalBulletPoint>
              Operations that include Cat DDOs are evolving from standalone
              ...
              <GlobalSubBulletPointsContainer>
                <GlobalSubBulletPoint>
                  ...
                  to DPOs combining upfront budget support with the Cat DDO
                  instrument, <SemiboldText>US$250 million</SemiboldText> has
                  been allocated specifically to Cat DDOs.
                </GlobalSubBulletPoint>
                <GlobalSubBulletPoint>
                  This shift is reflected in the growing number of Cat DDOs
