                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 p-4 rounded-md">
                      ...
                      <p className="text-sm text-blue-800">
                        This is a comprehensive modal component that supports
                        both stepped workflows and single modal dialogs. It
                        includes features like progress indicators, step
                        validation, and customizable styling.
                      </p>
                    </div>
                ...
                <StepModal.Body>
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600">
                      This modal demonstrates custom styling options including
                      custom colors, positioning, backdrop styling, and disabled
                      backdrop closing.
                    </p>
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg">
                      <p className="text-sm text-purple-800">
                        You can customize colors, sizes, positions, animations,
                        and much more to match your application&aposs design
                        system.
                      </p>
                    </div>
                  </div>
