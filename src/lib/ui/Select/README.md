...
- **Select.tsx**: Main component that orchestrates the various parts
- **Select.d.ts**: TypeScript interfaces for props and data structure
- **hooks/useSelect.ts**: Business logic isolated into a hook
- **context/SelectContext.tsx**: Context for sharing state across components
- **Select.styled.tsx**: Styled components (using Tailwind) for visual elements
