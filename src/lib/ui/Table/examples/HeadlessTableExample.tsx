import { usePagination, useSorting, useSelection } from '../hooks';
...
export default function HeadlessTableExample() {
  // Client-side hooks
  ...
  // Get paginated data
  const rows = pagination.getPageData(sorting.sortedData);

  return (
    <div className="p-6 bg-white rounded-lg shadow">
      <h2 className="text-2xl font-bold mb-6">
        Headless Table Example (Client-Side)
      </h2>
      ...
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={() => sorting.toggleSort('role', true)}
        ...
        <PageSizeSelector pagination={pagination} options={[3, 5, 10]} />
      </div>
